...
from services.book_quotes import get_book_quotes, add_book_quote, get_book_quotes_by_author, get_book_quotes_by_title
...
@book_quotes.route("/book-quotes/title/<book_title>", methods=["GET"])
def get_quotes_by_title(book_title):
    return get_book_quotes_by_title(book_title)
